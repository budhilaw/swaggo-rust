...
func main() {
    // ...
        ...
        assert_eq!(api_info.info.description, Some("This is a sample server.".to_string()));
        assert_eq!(api_info.info.terms_of_service, Some("http://swagger.io/terms/".to_string()));
        ...
        assert_eq!(contact.url, Some("http://www.swagger.io/support".to_string()));
        ...
        assert_eq!(license.url, Some("http://www.apache.org/licenses/LICENSE-2.0.html".to_string()));
    ...
    fn test_parse_operations() {
        ...
        assert_eq!(op.operation.description, Some("Test description".to_string()));
